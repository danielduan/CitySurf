...
<div id="menu" class="osd">
    ...
    <p>
         Avoid hitting cubes by moving with left and right arrow keys<br>
         Leap Motion: hover hand over Leap and move left or right<br>
        <br>
    ...
    <div id="facebook">
        <div class="fb-like" data-href="http://citysurf.herokuapp.com" data-width="450" data-colorscheme="dark" data-layout="button_count" data-show-faces="false" data-send="true"></div>
        	<div>
