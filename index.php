...
<div id="menu" class="osd">
    ...
    <p>
         Avoid cubes by using left and right arrow keys<br>
         Leap Motion: move hand left and right<br>
        <br>
    ...
    <div id="facebook">
        <div class="fb-like" data-href="http://developers.facebook.com/docs/reference/plugins/like" data-width="450" data-colorscheme="dark" data-layout="button_count" data-show-faces="false" data-send="true"></div>
        	<div>
